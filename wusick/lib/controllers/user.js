...
//Función añadir amigos (solicitud)
		...
		var id2 = req.params.id2;
		  ...
		  var query = 'INSERT INTO solicitudes VALUES ('+id+','+id2+') ';
		    ...
		    sqlconnection.query(query, function(err, results) {
	        	...
	        	console.log("Usuario "+id+" env�a petici�n de amistad a usuario "+id2);
			    	sqlconnection.end();
...
//Función añadir amigos (tabla amigos)
		...
		var id2 = req.params.id2;
		  ...
		  var query = 'INSERT INTO usuarios_has_usuarios VALUES ('+id+','+id2+') ';
		    ...
		    sqlconnection.query(query, function(err, results) {
	        	...
	        	console.log("Usuario "+id+" a�ade como amigo a "+id2);
		    ...
		    sqlconnection.query(query2, function(err, results) {
	        	...
	        	console.log("Usuario "+id2+" a�ade como amigo a "+id);
			    	sqlconnection.end();
...
//Función borrar solicitudes de amigos
...
//Función mostrar numero solicitudes de amistad
...
//Funciónn mostrar solicitudes de amistad
